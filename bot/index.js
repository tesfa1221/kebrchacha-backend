...
bot.start(function(ctx) {
  ...
  var msg = [
    '🎲 እንኳን ወደ ከብርቻቻ (KEBRCHACHA) በደህና መጡ! 🎲',
    '',
    'የዕድልዎን መናወጥ ለመሞከር እና በትንሽ ኢንቨስትመንት ትልቅ ሽልማቶችን ለማሸነፍ ትክክለኛው ቦታ ላይ ነዎት።',
    'ከብርቻቻ ዘመናዊ፣ ግልጽ እና ታማኝ የሆነ የዲጂታል እጣ ማውጫ መድረክ ነው።',
    '',
    '━━━━━━━━━━━━━━━━━━━━━',
    'ለመጀመር የሚከተሉትን ደረጃዎች ይከተሉ፦',
    '━━━━━━━━━━━━━━━━━━━━━',
    '',
    '1️⃣ ክፍል ይምረጡ፦ በአሁኑ ሰዓት ክፍት የሆኑ የጨዋታ ክፍሎችን (Rooms) ከታች ካለው ዝርዝር ይምረጡ።',
    '2️⃣ ቁጥርዎን ይያዙ፦ ከ' + '1-50 ባለው የቁጥር ሰንጠረዥ ላይ የፈለጉትን እድለኛ ቁጥር ይምረጡ።',
    '3️⃣ ክፍያዎን ያረጋግጡ፦ የቴሌብር ክፍያ በመፈጸም ደረሰኙን ይላኩ። ቁጥሩ ወዲያውኑ በስምዎ ይያዛል።',
    '4️⃣ እጣውን ይጠብቁ፦ የክፍሉ ተጫዋቾች እንደሞሉ ሲስተሙ በራሱ አሸናፊዎችን ይለያል!',
    '',
    '━━━━━━━━━━━━━━━━━━━━━',
    '📍 ማሳሰቢያ፦ ሁሉም የእጣ አወጣጥ ሂደቶች በዘመናዊ ቴክኖሎጂ የታገዙ እና ፍጹም ግልጽነት ያላቸው ናቸው።',
    '',
    'መልካም ዕድል! 🍀'
  ].join('\n');
